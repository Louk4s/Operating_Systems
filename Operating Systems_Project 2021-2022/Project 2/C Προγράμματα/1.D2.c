/**********************************************************/
/* 					   Program 1.D2.c  			          */
/* Parking application as a special case of Producer /    */
/* Consumer problem                                       */
/**********************************************************/
...
/* free_aSem is a binary semaphore and free_sSem is a general (counting) semaphore */
semaphore *free_aSem, *free_sSem;  

int *free_a;  /* shared var */
...
{	
    ...
    /* attach free_a to shared memory */
    free_a = (int *) shmat (shmid1, NULL, 0);  

	/* initialize semaphores for shared processes */
    free_aSem = sem_open ("free_aSem", O_CREAT | O_EXCL, 0644, 1);  /* binary semaphore */
    free_sSem = sem_open ("free_sSem", O_CREAT | O_EXCL, 0644, N);  /* counting semaphore */
